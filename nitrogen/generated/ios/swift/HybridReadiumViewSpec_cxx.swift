...
open class HybridReadiumViewSpec_cxx {
  ...
  @inline(__always)
  public final func getBookmarkLocation() -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.getBookmarkLocation()
  ...
  @inline(__always)
  public final func goToBookmark(json: std.string) -> bridge.Result_std__shared_ptr_Promise_bool___ {
    do {
      let __result = try self.__implementation.goToBookmark(json: String(json))
