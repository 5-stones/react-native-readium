...
/**
 * Represents an instance of `ComicPreferences`, backed by a C++ struct.
 */
public typealias ComicPreferences = margelo.nitro.readium.ComicPreferences

public extension ComicPreferences {
  private typealias bridge = margelo.nitro.readium.bridge.swift

  /**
   * Create a new instance of `ComicPreferences`.
   */
  init(readingProgression: String?, spread: String?, fit: String?, offsetFirstPage: Bool?) {
