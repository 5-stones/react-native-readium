...
// Bookent-specific scripts are isolated from the upstream navigator integration.
...
enum BookentInlineScript {
  static func make(publication: Publication, initialScale: Double, knownVocabularyJSON: String) -> String {
    let source = """
