...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::readium::Point> final {
    static inline margelo::nitro::readium::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::readium::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::readium::Point& arg) {
