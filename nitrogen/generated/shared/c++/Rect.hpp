...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::readium::Rect> final {
    static inline margelo::nitro::readium::Rect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::readium::Rect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::readium::Rect& arg) {
