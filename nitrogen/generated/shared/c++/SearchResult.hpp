...
namespace margelo::nitro::readium {
  ...
  public:
    ...
    explicit SearchResult(Locator locator, std::optional<std::string> title, std::optional<std::string> snippet, double index): locator(locator), title(title), snippet(snippet), index(index) {}
  ...
  struct JSIConverter<margelo::nitro::readium::SearchResult> final {
    static inline margelo::nitro::readium::SearchResult fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::readium::SearchResult(
        ...
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "snippet"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::readium::SearchResult& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "snippet"), JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.snippet));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "snippet")))) return false;
