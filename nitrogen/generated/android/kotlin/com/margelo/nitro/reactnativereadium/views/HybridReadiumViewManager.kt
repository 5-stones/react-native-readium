///
/// HybridReadiumViewManager.kt
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © Marc Rousavy @ Margelo
///

package com.margelo.nitro.reactnativereadium.views
...
/**
 * Represents the React Native `ViewManager` for the "ReadiumView" Nitro HybridView.
 */
public class HybridReadiumViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridReadiumView::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridReadiumView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridReadiumViewStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridReadiumView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridReadiumView
  }
}
