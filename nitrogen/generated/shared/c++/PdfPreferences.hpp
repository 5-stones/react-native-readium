...
namespace margelo::nitro::readium {
  ...
  /**
   * A struct which can be represented as a JavaScript object (PdfPreferences).
   */
  struct PdfPreferences final {
  public:
  ...
  public:
    PdfPreferences() = default;
    explicit PdfPreferences(std::optional<std::string> readingProgression, std::optional<bool> scroll, std::optional<std::string> spread, std::optional<std::string> fit, std::optional<bool> offsetFirstPage): readingProgression(readingProgression), scroll(scroll), spread(spread), fit(fit), offsetFirstPage(offsetFirstPage) {}

  public:
    friend bool operator==(const PdfPreferences& lhs, const PdfPreferences& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ PdfPreferences <> JS PdfPreferences (object)
  template <>
  struct JSIConverter<margelo::nitro::readium::PdfPreferences> final {
    static inline margelo::nitro::readium::PdfPreferences fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::readium::PdfPreferences(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::readium::PdfPreferences& arg) {
